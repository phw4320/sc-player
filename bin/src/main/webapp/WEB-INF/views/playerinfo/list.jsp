...
<!-- <script src="/common/form.jspf"></script>
</head>
<style>
.src-image {
  display: none;
	...
	var conf = {
			...
			success : function(res){
			 ...
			 /*    for(var sc of res){
					 ...
					 */
			    	html += '<section id="team" class="pb-5">';
					html += ' <div class="container">';
					html += ' <h5 class="section-title h1" align="center">SOCCER PLAYER PROFILE</h5>';
					html += '  <div class="row">';
					...
					html += '  <p><img class=" img-fluid" src="https://sunlimetech.com/portfolio/boot4menu/assets/imgs/team/img_01.png" alt="card image"></p> ';
					...
					html += ' <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-plus">상세보기</i></a>';
					html += '   </div>';
					html += '  </div>';
					html += '  </div>';
