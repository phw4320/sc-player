	...
	<div class="container" align="center">
		<form action="/playerinfo/upload" method="post" name="form"
			...
			<table class="table tabla-hover table-bordered">
				<tr>
					<th>선수 이름</th>
					<td><input type="text" onblur="chceckValid (this.form,this)"
						class="form-control" placeholder="선수 이름 입력" name="scname"
						maxlength="33" required></td>
				</tr>
				<tr>
					<th>소속 팀</th>
					<td><input type="text" onblur="chceckValid(this.form,this)"
						placeholder="소속 팀 이름 입력" class="form-control" name="sctimname"
						maxlength="33" required></td>

				</tr>
				<tr>
					<th>등 번호</th>
					<td><input type="number" onblur="chceckValid(this.form,this)"
						class="form-control" placeholder="등 번호 입력" name="scbacknum"
						max="99" min="0" maxlength="2" oninput="max(this)" required></td>
				</tr>
				<tr>
					<th>포지션</th>
					<td><input type="text" class="form-control"
						placeholder="포지션 입력" onblur="chceckValid(this.form,this)"
						name="scposition" maxlength="6" required></td>
				</tr>
				<tr>
					<th>출신 국가</th>
					<td><input type="text" onblur="chceckValid(this.form,this)"
						placeholder="소속 국가 입력" class="form-control" name="sccountry"
						maxlength="18" required></td>
				</tr>
				<tr>
					<th>키</th>
					<td><input type="number" onblur="chceckValid(this.form,this)"
						placeholder="키 입력" class="form-control" name="scheight" max="250"
						min="0" maxlength="3" required></td>
				</tr>
				<tr>
					<th>몸무게</th>
					<td><input type="number" onblur="chceckValid(this.form,this)"
						placeholder="몸무게 입력" class="form-control" name="scweight"
						max="700" min="0" maxlength="3" required></td>
				</tr>
				<tr>
					<th>생일</th>
					<td><input type="date" onblur="chceckValid(this.form,this)"
				...
				<tr>
					...
					<td><select name="scbloodtype"
						onblur="chceckValid(this.form,this)" class="form-control" required>
				...
				<tr>
					<th>프로필 사진</th>
					<td><input type="file" onblur="chceckValid(this.form,this)"
						onchange="checkFile(this)" accept=".jpg,.png" class="form-control"
