...
<link href="/vendor/bootstrap/css/bootstrap.min.js" rel="stylesheet">
<link href="/vendor/jquery/jquery-3.3.1.min.js" rel="stylesheet">
	...
	var conf = {
			...
			success : function(res){
			    ...
			    for(var sc of res){
			    	...
			    	html += '<h1> soccer player profile </h1>';
